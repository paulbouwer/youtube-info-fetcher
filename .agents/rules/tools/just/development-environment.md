# Just Development Environment Rule
...
This rule is the **index** for the development environments from which a human user or an AI agent can productively use the project's command runner. It declares the cross-environment tool requirements and routes to per-environment files for the satisfaction details.
...
- [`just`](tooling.md#just) — command runner for build, test, lint, format, and CI-equivalent recipes
