# Go Development Environment Rule
...
This rule is the **index** for the development environments from which a human user or an AI agent can productively author Go code for the project. It declares the cross-environment tool requirements and routes to per-environment files for the satisfaction details.
...
- [`golangci-lint`](tooling.md#golangci-lint) — aggregated linter and formatter for Go source
- [`govulncheck`](tooling.md#govulncheck) — vulnerability scanner for Go modules
