...
- `RESEARCH_SKILL := $AGENT_SYSTEM_FOLDER/skills/research`
...
| Research | research, investigate, dossier, evidence, sources, synthesise | `$RESEARCH_SKILL` | create-research, synthesise-research |
