...
This rule is the **index** for the development environments from which a human user or an AI agent can productively work in the <domain> domain. It declares the cross-environment tool requirements and routes to per-environment files for the satisfaction details.
...
- [`<tool-name>`](tooling.md#<tool-name>) — <one-phrase purpose>
- [`<tool-name>`](tooling.md#<tool-name>) — <one-phrase purpose>
